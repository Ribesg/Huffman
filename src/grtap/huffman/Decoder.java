...
public class Decoder {
	...
	public void decode() throws IOException {
        ...
        try (final FileInputStream reader = new FileInputStream(from.toFile()); 
        		final BufferedWriter writer = Files.newBufferedWriter(to, CHARSET)) {
	...
	private HashMap<BitArray, Character> getCodes() throws IOException {
		...
		try (final BufferedReader reader = Files.newBufferedReader(from,
				CHARSET)) {
